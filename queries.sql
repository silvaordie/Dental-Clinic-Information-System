...
where employee.name = "Jane Sweettoth" and employee.VAT = appointment.VAT_doctor and appointment.VAT = consultation.VAT 
	and appointment.VAT_client = client.VAT and phone_number_client.VAT = client.VAT
